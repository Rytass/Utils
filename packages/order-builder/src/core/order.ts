...
> {
   ...
   * @returns {Order} Order
   */
  addCoupon(id: Coupon): Order<Item, Coupon>;
  /**
   * Push couponId into `order`.`coupons`
   * @param {Array} ids String[]
   * @returns {Order} Order
   */
  addCoupon(ids: Coupon[]): Order<Item, Coupon>;
   ...
   * @returns {Order} Order
   */
  removeCoupon(id: Coupon): Order<Item, Coupon>;
  /**
   * Remove couponId from `order`.`coupons` if exists.
   * @param {Array} ids String[]
   * @returns {Order} Order
   */
  removeCoupon(ids: Coupon[]): Order<Item, Coupon>;
