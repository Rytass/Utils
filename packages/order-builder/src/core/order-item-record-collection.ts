 ...
 */
export class OrderItemRecordCollection<Item extends OrderItem = OrderItem> {
  ...
  get discountValue(): number {
    return this.discountRecords.reduce((total, discount) => plus(total, discount.discountValue), 0);
  }
