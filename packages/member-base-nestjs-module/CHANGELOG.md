...
- **member-base-nestjs-module:** authenticate and read directories against microsoft entra id
- **member-base-nestjs-module:** name the directory capability as `DirectoryProvider`
- **member-base-nestjs-module:** mount login routes for redirect providers on request
...
- **member-base-nestjs-module:** run the subpath isolation suite again
